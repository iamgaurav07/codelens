  ...
  return (
    <div style={{ fontFamily: "'DM Sans', 'Helvetica Neue', sans-serif", background: "#0A0A0F", minHeight: "100vh", color: "#fff", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "24px" }}>
      ...
      <div style={{ width: "100%", maxWidth: 400, background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: 16, padding: "40px" }}>
        <h1 style={{ fontSize: 24, fontWeight: 800, letterSpacing: "-0.04em", margin: "0 0 8px" }}>Create account</h1>
        <p style={{ color: "rgba(255,255,255,0.4)", fontSize: 14, margin: "0 0 32px" }}>Start reviewing code with AI today</p>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 24 }}>
          ...
          <span style={{ fontSize: 12, color: "rgba(255,255,255,0.3)" }}>or sign up with email</span>
          <div style={{ flex: 1, height: 1, background: "rgba(255,255,255,0.08)" }}/>
        </div>
        ...
        <form onSubmit={handleRegister} style={{ display: "flex", flexDirection: "column", gap: 14 }}>
          <div>
            <label style={{ fontSize: 13, color: "rgba(255,255,255,0.5)", display: "block", marginBottom: 6 }}>Full name</label>
            <input
              type="text"
              value={name}
        ...
        <p style={{ textAlign: "center", fontSize: 13, color: "rgba(255,255,255,0.4)", marginTop: 24, marginBottom: 0 }}>
          ...
          <Link href="/login" style={{ color: "#6EE7B7", textDecoration: "none", fontWeight: 600 }}>
            Sign in
          </Link>
        </p>

        <p style={{ textAlign: "center", fontSize: 11, color: "rgba(255,255,255,0.2)", marginTop: 16, marginBottom: 0, lineHeight: 1.6 }}>
